...
${OBJECTDIR}/Angiosperma.o: Angiosperma.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Angiosperma.o Angiosperma.cpp
...
${OBJECTDIR}/Bien.o: Bien.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Bien.o Bien.cpp

${OBJECTDIR}/Briofita.o: Briofita.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Briofita.o Briofita.cpp
...
${OBJECTDIR}/CilindroHueco.o: CilindroHueco.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CilindroHueco.o CilindroHueco.cpp
...
${OBJECTDIR}/Escaleno.o: Escaleno.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Escaleno.o Escaleno.cpp

${OBJECTDIR}/Esfera.o: Esfera.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Esfera.o Esfera.cpp
...
${OBJECTDIR}/GestorContable.o: GestorContable.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GestorContable.o GestorContable.cpp

${OBJECTDIR}/GestorPoligonos.o: GestorPoligonos.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GestorPoligonos.o GestorPoligonos.cpp

${OBJECTDIR}/Hexagon.o: Hexagon.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Hexagon.o Hexagon.cpp

${OBJECTDIR}/Muebles.o: Muebles.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Muebles.o Muebles.cpp

${OBJECTDIR}/Musgos.o: Musgos.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Musgos.o Musgos.cpp

${OBJECTDIR}/Ortoedro.o: Ortoedro.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Ortoedro.o Ortoedro.cpp
...
${OBJECTDIR}/Pez.o: Pez.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Pez.o Pez.cpp
...
${OBJECTDIR}/PilaDoble.o: PilaDoble.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PilaDoble.o PilaDoble.cpp
...
${OBJECTDIR}/PoligonoIrregular.o: PoligonoIrregular.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PoligonoIrregular.o PoligonoIrregular.cpp

${OBJECTDIR}/PoligonoRegular.o: PoligonoRegular.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PoligonoRegular.o PoligonoRegular.cpp
...
${OBJECTDIR}/QueueCircular.o: QueueCircular.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QueueCircular.o QueueCircular.cpp

${OBJECTDIR}/Rana.o: Rana.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Rana.o Rana.cpp
...
${OBJECTDIR}/Reptil.o: Reptil.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Reptil.o Reptil.cpp

${OBJECTDIR}/Rodado.o: Rodado.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Rodado.o Rodado.cpp

${OBJECTDIR}/Rombo.o: Rombo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Rombo.o Rombo.cpp

${OBJECTDIR}/Rosales.o: Rosales.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Rosales.o Rosales.cpp

${OBJECTDIR}/Serpiente.o: Serpiente.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Serpiente.o Serpiente.cpp

${OBJECTDIR}/TarjetaDeCredito.o: TarjetaDeCredito.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TarjetaDeCredito.o TarjetaDeCredito.cpp
...
${OBJECTDIR}/Tiburon.o: Tiburon.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tiburon.o Tiburon.cpp
