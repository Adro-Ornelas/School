...
${OBJECTDIR}/LDLCIRCIPSNC.o: LDLCIRCIPSNC.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LDLCIRCIPSNC.o LDLCIRCIPSNC.cpp

${OBJECTDIR}/LDLCIRCIVCNC.o: LDLCIRCIVCNC.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LDLCIRCIVCNC.o LDLCIRCIVCNC.cpp
...
${OBJECTDIR}/LDLTNIPCNC.o: LDLTNIPCNC.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LDLTNIPCNC.o LDLTNIPCNC.cpp
...
${OBJECTDIR}/LDLTNIVCNC.o: LDLTNIVCNC.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LDLTNIVCNC.o LDLTNIVCNC.cpp

${OBJECTDIR}/LDLTNIVSNC.o: LDLTNIVSNC.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LDLTNIVSNC.o LDLTNIVSNC.cpp
...
${OBJECTDIR}/Recursividad.o: Recursividad.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Recursividad.o Recursividad.cpp
