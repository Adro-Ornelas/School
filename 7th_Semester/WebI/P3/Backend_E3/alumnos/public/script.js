...
<button id="modalInput" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
  Launch demo modal
</button>
          </td>
          <td><button class="btn btn-warning" type="button" value="${a.id}">EDIT</button></td>
          <td><button class="btn btn-danger" type="button" value="${a.id}">DEL</button></td>
        </tr>`;
